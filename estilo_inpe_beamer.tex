...
\begin{itemize}
	...
	\pause
	\item Verifique os slides a seguir e depois olhe o arquivo {\tt estilo\_inpe\_beamer.tex} para ver como o frame com a estrutura que você precisa foi montado.
	\pause
...
\begin{itemize}
	\item Neste frame, o texto está inserido diretamente, sem a utilização de blocos.
	\pause
	\item Após a utilização do comando {\tt pause}, pode-se adicionar mais conteúdo em um segundo frame, mas utilizando a mesma estrutura do frame atual.
\end{itemize}
\end{frame}
...
Esta frase está escrita fora de um bloco, diretamente no frame.
...
Neste frame, é mostrado um exemplo de texto e figura.
\pause
\begin{figure}
	\centering
...
\framesubtitle{Figura e texto}
Neste frame, é mostrado um exemplo de texto e um painel de figuras.
\pause
\begin{figure}[H]
    \begin{center}
...
\begin{frame}
\frametitle{Referências Bibliográficas}
%\framesubtitle{Lista de Referências}
